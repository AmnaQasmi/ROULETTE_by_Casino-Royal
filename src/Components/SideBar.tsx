...
{/* #877337 */}
      <Drawer.Root
        className='bs:hidden !-z-10' position='right' size={'30vw'} opened={opened} onClose={toggle}>
      ...
      <Burger className='bs:!hidden !z-50 !relative' color='#877337' lineSize={4} size={size} opened={opened} onClick={toggle} />
